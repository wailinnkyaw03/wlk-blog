<nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            ...
            <a class="navbar-brand ps-3" href="../../index.php">
                <img class="me-2" src="../../assets/img/logo.png" width="40px" alt="">
            ...
            <ul class="navbar-nav ms-auto ms-md-0 me-3 me-lg-4">
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle active" id="navbarDropdown" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                        ...
                        <img src="../../assets/profiles/<?= $_SESSION['user']['profile'] ?>" width="35px" class="rounded-circle me-2" alt="">
                        <?= $_SESSION['user']['name'] ?>
                    </a>
                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                        <li><a class="dropdown-item" href="../../index.php?page=profile">Admin Profile</a></li>
